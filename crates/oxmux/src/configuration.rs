...
struct RawConfiguration {
    version: Option<i64>,
    proxy: Option<RawProxyConfiguration>,
    #[serde(default)]
    providers: Vec<RawProviderConfiguration>,
    #[serde(default)]
    routing: RawRoutingConfiguration,
    #[serde(default)]
    observability: RawObservabilityConfiguration,
    #[serde(default)]
    lifecycle: RawLifecycleConfiguration,
}

#[derive(Debug, Deserialize)]
#[serde(rename_all = "kebab-case", deny_unknown_fields)]
struct RawProxyConfiguration {
...
struct RawProviderConfiguration {
    ...
    routing_eligible: Option<bool>,
    #[serde(default)]
    accounts: Vec<RawAccountConfiguration>,
}

#[derive(Debug, Deserialize)]
#[serde(rename_all = "kebab-case", deny_unknown_fields)]
struct RawAccountConfiguration {
    id: Option<String>,
...
#[serde(rename_all = "kebab-case", deny_unknown_fields)]
struct RawRoutingConfiguration {
    #[serde(default)]
    defaults: Vec<RawRoutingDefaultConfiguration>,
}

#[derive(Debug, Deserialize)]
#[serde(rename_all = "kebab-case", deny_unknown_fields)]
struct RawRoutingDefaultConfiguration {
    name: Option<String>,
    model: Option<String>,
...
#[derive(Debug, Deserialize)]
#[serde(default, rename_all = "kebab-case", deny_unknown_fields)]
struct RawLifecycleConfiguration {
