...
Define the minimal headless `oxmux` proxy engine path for OpenAI-compatible chat-completion smoke requests without desktop shell or real provider-network dependencies.
