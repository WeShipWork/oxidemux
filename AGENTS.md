...
* Avoid god-files. Keep files focused on one coherent responsibility and prefer extracting a new logical component before a file grows beyond 800 lines. If a file must temporarily exceed 800 lines, document the reason in the implementation plan and include a follow-up split task.
